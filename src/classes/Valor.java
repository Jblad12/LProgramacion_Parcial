...
//Clase que almacenara los atomos del lenguaje
public class Valor implements Comparable {
    ...
    public Boolean aBoolean() {
        try {
            //Asigna un valor booleano a un numero
    ...
    //Traduccion de los output por defecto
    @Override
...
//Traduccion de la clase ComplexNumber (Complex) obtenida de: https://github.com/abdulfatir/jcomplexnumber/blob/master/com/abdulfatir/jcomplexnumber/ComplexNumber.java
